    ...
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"E:\22.11.4748\praktikum8\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            DialogResult result1 = MessageBox.Show("Apakah anda yakin ingin menghapus data mahasiswa?", "Konfirmasi Hapus", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
            if (result1 == DialogResult.Yes)
            {
                ...
                if (result > 0)
                {
                    MessageBox.Show("Data mahasiswa berhasil didelete !", "Informasi",
                   MessageBoxButtons.OK,
                    MessageBoxIcon.Information);
                    // reset form
                    txtNpmDelete.Clear();
